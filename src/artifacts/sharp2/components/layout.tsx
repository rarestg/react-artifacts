...
/**
 * Sharp2-local layout primitives for the showcase.
 *
...
type DemoGridMin = '12rem' | '14rem' | '18rem' | '20rem';

const gridColsClass: Record<DemoGridMin, string> = {
...
/**
 * Responsive auto-fit demo grid. Direct children are made shrinkable (`*:min-w-0`)
 * so text can truncate; wrap a child if it genuinely needs an intrinsic min width.
 */
export function DemoGrid({ min = '18rem', gap = 'section', className, children }: DemoGridProps) {
  return (
